...
class Player:
    def __init__(self, score, uuid, username, img_id, channel_name):
        self.score = score
        self.uuid = uuid
...
class MatchHandler:
    def add_player(self, score, uuid, username, img_id, channel_name):
        print("Add Player: %s %d" % (username, score))
        player = Player(score, uuid, username, img_id, channel_name)
        queue.put(player)
        return 0
